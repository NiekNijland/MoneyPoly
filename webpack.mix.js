...
mix.sass(`resources/assets/sass/style.scss`, `public/css/style.bundle.css`, {sassOptions: {includePaths: ['node_modules']}})
    ...
    .js([`resources/assets/js/scripts.js`, 'resources/assets/extended/button-ajax.js'], `public/js/scripts.bundle.js`);
...
if (args.indexOf('dark_mode') !== -1) {
    ...
    mix.sass(`resources/assets/sass/plugins.dark.scss`, `public/plugins/global/plugins-custom.dark.bundle.css`);
    mix.sass(`resources/assets/sass/style.dark.scss`, `public/css/style.dark.bundle.css`, {sassOptions: {includePaths: ['node_modules']}});
}
...
(glob.sync(`resources/assets/plugins/**/*.+(woff|woff2|eot|ttf)`) || []).forEach(file => {
