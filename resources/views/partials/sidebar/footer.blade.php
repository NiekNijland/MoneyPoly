<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
    ...
    <div class="d-flex align-items-center mb-2">
        <div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="" data-bs-original-title="Quick links">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('https://preview.keenthemes.com/metronic8/laravel/demo7/media/misc/pattern-1.jpg')">
            ...
            <div class="row g-0">
                <div class="col-6">
                    <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/budget?demo=demo7" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                        <!--begin::Svg Icon | path: assets/media/icons/duotune/finance/fin009.svg-->
                        <span class="svg-icon svg-icon-3x svg-icon-success mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="col-6">
                    <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/settings?demo=demo7" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                ...
                <div class="col-6">
                    <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/list?demo=demo7" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                        <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs042.svg-->
                        <span class="svg-icon svg-icon-3x svg-icon-success mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="col-6">
                    <a href="https://preview.keenthemes.com/metronic8/laravel/pages/projects/users?demo=demo7" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
            ...
            <div class="py-2 text-center border-top">
                <a href="https://preview.keenthemes.com/metronic8/laravel/pages/profile/activity?demo=demo7" class="btn btn-color-gray-600 btn-active-color-primary">
                    View All
                    {!! $themeService->getSvgIcon('media/icons/duotune/arrows/arr064.svg') !!}
                </a>
            </div>
        </div>
    </div>
    <div class="d-flex align-items-center mb-2">
        <div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="" data-bs-original-title="Notifications">
            <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen025.svg-->
            <span class="svg-icon svg-icon-2 svg-icon-lg-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('https://preview.keenthemes.com/metronic8/laravel/demo7/media/misc/pattern-1.jpg')">
            ...
            <div class="tab-content">
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px me-4">
                                                 ...
                                                 <span class="svg-icon svg-icon-2 svg-icon-danger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px me-4">
                                                 ...
                                                 <!--begin::Svg Icon | path: assets/media/icons/duotune/finance/fin006.svg-->
                                                 <span class="svg-icon svg-icon-2 svg-icon-warning"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                 <path opacity="0.3" d="M20 15H4C2.9 15 2 14.1 2 13V7C2 6.4 2.4 6 3 6H21C21.6 6 22 6.4 22 7V13C22 14.1 21.1 15 20 15ZM13 12H11C10.5 12 10 12.4 10 13V16C10 16.5 10.4 17 11 17H13C13.6 17 14 16.6 14 16V13C14 12.4 13.6 12 13 12Z" fill="black"></path>
                                                 <path d="M14 6V5H10V6H8V5C8 3.9 8.9 3 10 3H14C15.1 3 16 3.9 16 5V6H14ZM20 15H14V16C14 16.6 13.5 17 13 17H11C10.5 17 10 16.6 10 16V15H4C3.6 15 3.3 14.9 3 14.7V18C3 19.1 3.9 20 5 20H19C20.1 20 21 19.1 21 18V14.7C20.7 14.9 20.4 15 20 15Z" fill="black"></path>
                                                 </svg></span>
                                                     <!--end::Svg Icon-->
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px me-4">
                                                 ...
                                                 <span class="svg-icon svg-icon-2 svg-icon-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px me-4">
                                                 ...
                                                 <span class="svg-icon svg-icon-2 svg-icon-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-35px me-4">
                                                 ...
                                                 <span class="svg-icon svg-icon-2 svg-icon-warning"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                    ...
                    <div class="d-flex flex-column px-9">
                        ...
                        <!--begin::Illustration-->
                        <img class="mh-200px" alt="metronic" src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/illustrations/sketchy-1/1.png">
                        <!--end::Illustration-->
                    </div>
                    <!--end::Wrapper-->
                </div>
    ...
    <div class="d-flex align-items-center mb-3">
        <!--begin::Drawer toggle-->
        <div class="btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="" id="kt_activities_toggle" data-bs-original-title="Activity Logs">
    ...
    <div class="d-flex align-items-center mb-10">
        <div
            ...
            dusk="employee-menu-toggle"
        >
            <img src="{{ asset(Auth::user()->avatar_path) }}" alt="avatar" id="employee-menu-toggle-avatar">
        </div>
        @livewire('employee-menu-component', ['employee' => Auth::user()])
    </div>
</div>
