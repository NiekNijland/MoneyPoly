    ...
    <div class="tab-pane fade " id="kt_aside_nav_tab_projects" role="tabpanel">
        ...
        <div class="m-0">
            ...
            <div class="d-flex mb-10">
                <!--begin::Search-->
                <div id="kt_header_search" class="d-flex align-items-center w-lg-400px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start" data-kt-search="true">
                    ...
                    <form data-kt-search-element="form" class="w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
                        ...
                        <span class="svg-icon svg-icon-2 svg-icon-lg-1 svg-icon-gray-500 position-absolute top-50 translate-middle-y ms-5"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <span class="btn btn-flush btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 d-none me-4" data-kt-search-element="clear">
                                                 ...
                                                 <span class="svg-icon svg-icon-2 svg-icon-lg-1 me-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7 overflow-hidden" data-kt-menu="true">
                                ...
                                <div class="scroll-y mh-200px mh-lg-325px">
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/avatars/150-1.jpg" alt="">
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/avatars/150-3.jpg" alt="">
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/avatars/150-8.jpg" alt="">
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/avatars/150-11.jpg" alt="">
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-40px me-4">
                                            <img src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/avatars/150-12.jpg" alt="">
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                                 ...
                                                 <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/volicity-9.svg" alt="">
                                                 </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                                 <span class="symbol-label bg-light">
                                                 <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/tvit.svg" alt="">
                                                 </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                                 <span class="symbol-label bg-light">
                                                 <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/misc/infography.svg" alt="">
                                                 </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                                 <span class="symbol-label bg-light">
                                                 <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/leaf.svg" alt="">
                                                 </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                                 <span class="symbol-label bg-light">
                                                 <img class="w-20px h-20px" src="https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/tower.svg" alt="">
                                                 </span>
                                        </div>
                                        <!--end::Symbol-->
                            ...
                            <div class="scroll-y mh-200px mh-lg-325px">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-40px me-4">
                                                 ...
                                                 <span class="svg-icon svg-icon-2 svg-icon-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                 <path opacity="0.3" d="M17.7 5.59999C16.7 5.19999 15.5 5.50003 14.8 6.20003L10.2 10.8C9.5 11.5 8.4 11.8 7.5 11.5L5.10001 10.8V18.9H20.1V6.40004L17.7 5.59999Z" fill="black"></path>
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="pt-10 pb-10">
                                ...
                                <span class="svg-icon svg-icon-4x opacity-50"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                        ...
                        <!--begin::Input group-->
                        <div class="mb-5">
                            <select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="date_period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-1-60md" tabindex="-1" aria-hidden="true">
                                <option value="next" data-select2-id="select2-data-3-xscj">Within the next</option>
                                <option value="last">Within the last</option>
                                <option value="between">Between</option>
                                <option value="on">On</option>
                            </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-2-ywh9" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-timezone-gp-container" aria-controls="select2-timezone-gp-container"><span class="select2-selection__rendered" id="select2-timezone-gp-container" role="textbox" aria-readonly="true" title="Within the next">Within the next</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-8">
                            ...
                            <!--begin::Col-->
                            <div class="col-6">
                                <select name="date_typer" aria-label="Select a Timezone" data-control="select2" data-placeholder="Period" class="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-4-xb2u" tabindex="-1" aria-hidden="true">
                                    <option value="days" data-select2-id="select2-data-6-9u3l">Days</option>
                                    <option value="weeks">Weeks</option>
                                    <option value="months">Months</option>
                                    <option value="years">Years</option>
                                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-5-f32p" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-date_typer-kq-container" aria-controls="select2-date_typer-kq-container"><span class="select2-selection__rendered" id="select2-date_typer-kq-container" role="textbox" aria-readonly="true" title="Days">Days</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
            ...
            <div class="flex-shrink-0 ms-2">
                ...
                <!--begin::Menu-->
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_614df8ef6e211">
                    <!--begin::Header-->
                    <div class="px-7 py-5">
                    ...
                    <div class="px-7 py-5">
                        ...
                        <div class="mb-10">
                            ...
                            <!--begin::Input-->
                            <div>
                                <select class="form-select form-select-solid select2-hidden-accessible" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_614df8ef6e211" data-allow-clear="true" data-select2-id="select2-data-7-bqxb" tabindex="-1" aria-hidden="true">
                                    <option data-select2-id="select2-data-9-k9o0"></option>
                                    <option value="1">Approved</option>
                                    <option value="2">Pending</option>
                                    <option value="2">In Process</option>
                                    <option value="2">Rejected</option>
                                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-8-90aj" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single form-select form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-528n-container" aria-controls="select2-528n-container"><span class="select2-selection__rendered" id="select2-528n-container" role="textbox" aria-readonly="true" title="Select option"><span class="select2-selection__placeholder">Select option</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                            </div>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
        ...
        <div class="m-0">
            ...
            <div class="mb-10">
                <!--begin::Item-->
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    <!--begin::Symbol-->
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    ...
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    ...
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    ...
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/balloon.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    ...
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/infography.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    ...
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/disqus.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
                ...
                <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/projects/project?demo=demo7" class="custom-list d-flex align-items-center px-5 py-4">
                    ...
                    <div class="symbol symbol-40px me-5">
                                                 <span class="symbol-label">
                                                 <img src=" https://preview.keenthemes.com/metronic8/laravel/demo7/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center" alt="">
                                                 </span>
                    </div>
                    <!--end::Symbol-->
