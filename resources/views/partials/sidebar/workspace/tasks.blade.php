        ...
        <div class="mb-12">
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">Project Briefing</a>
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                                                 ...
                                                 <span class="svg-icon svg-icon-2x svg-icon-warning"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <!--begin::Text-->
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">Concept Design</a>
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                                                 ...
                                                 <span class="svg-icon svg-icon-2x svg-icon-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <!--begin::Text-->
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">Functional Logics</a>
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                                                 ...
                                                 <span class="svg-icon svg-icon-2x svg-icon-danger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <!--begin::Text-->
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">Development</a>
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                                                 ...
                                                 <span class="svg-icon svg-icon-2x svg-icon-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <!--begin::Text-->
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">Testing</a>
            ...
            <div class="d-flex align-items-center mb-7">
                ...
                <div class="symbol symbol-50px me-5">
                                                 <span class="symbol-label bg-light-success">
                                                 <!--begin::Svg Icon | path: assets/media/icons/duotune/files/fil010.svg-->
                                                 <span class="svg-icon svg-icon-2x svg-icon-success"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <!--begin::Text-->
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">HTML, CSS Coding</a>
            ...
            <div class="d-flex align-items-center ">
                ...
                <div class="symbol symbol-50px me-5">
                                                 <span class="symbol-label bg-light-danger">
                                                 <!--begin::Svg Icon | path: assets/media/icons/duotune/graphs/gra008.svg-->
                                                 <span class="svg-icon svg-icon-2x svg-icon-danger"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <!--begin::Text-->
                <div class="d-flex flex-column">
                    <a href=" https://preview.keenthemes.com/metronic8/laravel/pages/profile/overview?demo=demo7" class="text-gray-800 text-hover-primary fs-6 fw-bold">ReactJS Developer</a>
