<div>
    ...
    <button class="btn btn-primary mt-5 w-100" wire:click="$emit('ShowSendMoney', null)">
        <span class="mx-auto">
                Send to bank
        </span>
    </button>
    <button class="btn btn-warning mt-5 w-100" wire:click="$emit('ShowSendMoney', true)">
        <span class="mx-auto">
    ...
    >
        <div class="fw-bolder fs-3 rotate collapsible" data-bs-toggle="collapse" href="#players_scroll_content" role="button" aria-expanded="true" aria-controls="players_scroll_content">
            ...
            <h2 class="fs-2 fw-bold my-2">
                {{ __('player.players') }}
                <span class="fs-6 text-gray-400 ms-1">Select a player to transfer money</span>
            </h2>
        </div>
